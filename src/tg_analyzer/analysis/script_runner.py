...
class ScriptRunner:
    ...
    async def run_script(self, script_path: str, chat_data: str, 
                        template_name: str, **kwargs) -> Dict[str, Any]:
        """
    ...
    async def run_multiple_scripts(self, scripts: List[Dict[str, Any]], 
                                 chat_data: str, **kwargs) -> List[Dict[str, Any]]:
        """
        ...
        for script_info in scripts:
            ...
            try:
                result = await self.run_script(script_path, chat_data, template_name, **kwargs)
                results.append({
                    'template': template_name,
                    'result': result,
    ...
    def validate_script(self, script_path: str) -> List[str]:
        ...
        try:
            ...
            if 'return {' not in content and 'return dict(' not in content:
                errors.append("Script must return a dictionary with 'result' and 'format' keys")
