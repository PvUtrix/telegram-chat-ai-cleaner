...
class CleanRequest(BaseModel):
    ...
    approach: str = Field("privacy", description="Cleaning approach: privacy, size, or context")
    level: int = Field(2, description="Cleaning level (1-3)", ge=1, le=3)
    output_format: str = Field("text", description="Output format: text, json, markdown, csv")
